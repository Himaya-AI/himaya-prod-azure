...
SYSTEM_PROMPT = """You are Bluebird, a security intelligence assistant for the Himaya email security platform. 
...
async def generate_report(
    ...
    elements.append(Paragraph(
        "<i>This report was generated by Himaya Security Platform. For questions, contact your administrator.</i>",
