...
class AuditReportGenerator:
    ...
    def generate_report(
        ...
        def _draw_cover(canv, doc):
            ...
            if _cover_meta["logo_path"]:
                try:
                    ...
                    pass
            # "HIMAYA HELIOS" in header
            canv.setFont("Helvetica-Bold", 11)
            canv.setFillColor(colors.white)
            canv.drawRightString(W - 1.8*_cm, H - 1.6*_cm, "HIMAYA HELIOS")
            ...
            meta_rows = [
                ...
                ("Platform",         "Himaya Helios · app.himaya.ai"),
            ]
        ...
        story.append(Spacer(1, 0.3 * cm))
        story.append(Paragraph(
            f"Generated by Himaya Helios Email Security Platform · app.himaya.ai · "
...
<div style="background:#1a1f3c;padding:24px 40px;display:flex;align-items:center;justify-content:space-between">
  ...
  <div style="color:#94a3b8;font-size:12px;text-align:right">
    ...
    Generated {date_str}<br>Powered by Himaya Helios
  </div>
</div>
...
<div style="background:#f8fafc;border-top:1px solid #e2e8f0;padding:20px 40px;text-align:center;color:#94a3b8;font-size:11px">
  This report is generated by Himaya Helios and is intended for internal compliance use only.<br>
...
def _generate_narrative(
    ...
    threat_stmt = (
        f"During the assessment period, Helios detected {threat_count} potential threats"
    ...
    return (
        ...
        f"This report was automatically generated by Himaya Helios and is intended for use in regulatory submissions and internal audits."
    )
...
def _generate_findings_and_recommendations(
    ...
    if threats:
        ...
        findings.append(
            f"Helios detected {len(threats)} threats during the reporting period. "
    ...
    recommendations.append(
        "Enable automated compliance evidence collection in Helios to continuously capture threat response actions as audit evidence."
    )
