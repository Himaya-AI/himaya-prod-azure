...
**Content Signals (observe these in the email body/headers/attachments — they are NOT reputation data):**
- URL obfuscation using URL shorteners or redirect chains
- Unusual financial amounts or account numbers in the body
- Requests for credentials, national ID.
## Response Format
